...
//        userRepository.save(user);
        String token = "a";
        String resetLink = "myapp://resetpassword?token=" + "token";
        String subject = "Resetovanje lozinke";
        String body = "Kliknite na sledeći link kako biste resetovali lozinku: " + resetLink;
        sendEmail(toEmail, subject, body);
    }

    private void sendEmail(String toEmail, String subject, String body) {
        SimpleMailMessage message = new SimpleMailMessage();
        message.setFrom("jovana.nikolic452@gmail.com");
