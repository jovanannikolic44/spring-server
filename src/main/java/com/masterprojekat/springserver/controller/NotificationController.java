...
public class NotificationController {
    ...
    public List<Notification> getAllNotificationsForStudent(@RequestParam String student_username) {
        return notificationService.getAllNotifications(student_username);
    }
}
